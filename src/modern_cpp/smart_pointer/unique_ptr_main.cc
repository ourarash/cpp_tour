...
/* Illustrative snippet showing how shared_ptr's reference count would behave
   across nested scopes. Not meant to compile here — included as teaching
   material to motivate the upcoming shared_ptr discussion.

...
int main(int argc, char const* argv[]) {
  ...
  {
    Vector2 a(1.0f, 2.0f), b(0.0f, 0.0f);
    b = a++;
    b = ++a;
  }

  // The shape we're benchmarking — postfix vs prefix in a loop:
  //   for (it = ...; ...; it++) {}   // postfix copies before incrementing
  //   for (it = ...; ...; ++it) {}   // prefix avoids the copy
  return 0;
}
